...
- **あきらめて Dockerfile 内でフルインストールした場合。**
  ...
  - :o: Dockerfile 内で使い終わったビルドツールを即座に捨ててレイヤーキャッシュの肥大化を最小限にとどめることができる。極限まで小さくしたい本番用イメージの作成なら結局これなのかもしれない。
...
entrykit とか fresh とか便利なツールがあるらしいので、そのうち調べてみたい。あとは、今は開発環境を作るために Docker を使ってるけど、いずれ Twelve Factor App とか実践したい。
